...
Original file is located at
    https://colab.research.google.com/drive/1NG7jczNRfmX7bSxrLcP8ZEtNdKQ8MeQT
"""
...
with DAG(
    ...
    start_date=datetime(2024, 10, 9),  # Adjust as necessary
    catchup=False,
    ...
    def create_table():
        ...
        with conn.cursor() as cur:
            try:
                ...
                cur.execute("USE DATABASE alpha_vabtage_stocks")  # Replace with your database name
                cur.execute("USE SCHEMA raw_data")  # Replace with your schema name
